...
import {getRandomSample} from "./utils/array-utils.ts";
...
const allSuggestions = [
    "Uh, could you show me what I spent on gas?", // Category
    "Hey, can I see my travel expenses for this month, please?", // Category, Date
    "Do you have a record of my salary history?", // Type (Income)
    "I'm trying to remember when I spent more than $1550 on groceries.", // Category, Amount
    "Can you pull up my entertainment expenses?", // Category
    "I'd like to see transactions between 500 and 1000 dollars.", // Amount
    "What did I pay for utilities last month?", // Category, Date
    "Can you show me income over two thousand dollars?", // Type (Income), Amount
    "What about my restaurant spending?", // Category
    "Can I see everything from last week?", // Date
    "Show me all the money I made in January.", // Type(Income), Date
    "What were my expenses for the whole of 2023?", // Type(Expense), Date
    "Could you show me everything over a thousand dollars from last month?", // Amount, Date
    "Anything under 50 bucks from last week?", // Amount, Date
    "I'm looking for expenses between one and five hundred dollars.", // Amount, Type(Expense)
    "Show me all income from the first half of January.", // Type(Income), Date
    "Can I see all my rent payments from last year?", // Category, Date
    "Show me everything I spent on food between 50 and 100 dollars.", // Category, Amount
    "I need to see my shopping expenses from last week that were over 200 dollars.", // Type(Expense), Category, Date, Amount
    "Can you pull up my salary income between two and five thousand dollars from last month?", // Type(Income), Category, Amount, Date
    "Show me all my travel spending from June first to July first that was less than a thousand dollars.", // Category, Date, Amount
    "I'm looking for expenses from last year between 500 and 1000 dollars for bills." // Type(Expense), Date, Amount, Category
];
...
function AppDashboard() {
    ...
    const [suggestions, setSuggestions] = useState(getRandomSample(allSuggestions, 2))
    ...
    const drawPieChart = () => {
        ...
        const centerX = canvas.width / 3; // Shift pie left for space
        ...
        const categoryTotals = filteredTransactions.reduce((acc: Record<string, any>, transaction) => {
            // if (transaction.type === "expense" || (typeFilter === "income" && transaction.type === "income")) {
        ...
        const legendX = centerX + radius + 20; // Shift right of pie
        let legendY = 30;
        ctx.font = "14px Arial";
        ...
        Object.entries(categoryTotals).forEach(([category, amount]) => {
            ...
            legendY += 25; // Increase spacing between items
        });
    };
    ...
    const handleChatSubmit = async (e: any, prompt: string = "") => {
        ...
        try {
            ...
            setIsLoading(false)
            setSuggestions(getRandomSample(allSuggestions, 2))
            console.log("done")
        }
    }
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <div style={{height: 50}}>
                        <div style={{display: isLoading ? "flex" : "none", alignItems: "center", marginBottom: "10px"}}>
                            <div
                                style={{
                                    width: "20px",
                                    height: "20px",
                        ...
                        <div style={{display: isLoading ? "none" : "flex", alignItems: "center", marginBottom: "10px"}}>
              <span>
                {filterSummary}
                  <span>
                  {filterSummary ? (
